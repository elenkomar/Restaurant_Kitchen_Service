...
from kitchen.views import (
    ...
    DishTypeCreateView,
    DishTypeUpdateView,
    DishTypeDeleteView, toggle_assign_to_dish, ToggleAssignToDishView,
)
...
urlpatterns = [
    ...
    path('toggle_assign_to_dish/<int:pk>/', ToggleAssignToDishView.as_view(), name='toggle_assign_to_dish'),
]
